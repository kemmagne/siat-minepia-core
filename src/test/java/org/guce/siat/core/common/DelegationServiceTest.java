...
public class DelegationServiceTest {
    ...
    /**
     * Find delegation by user and current date. Assert for each delegation
     * returned that it's delegation.toUser id is equal to the parametre id and
     * the current date is in between delegation.beginDate and
     * delegation.endDate
     */
    @Ignore
    @Test
