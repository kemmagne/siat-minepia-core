...
public class ItemFlowServiceTest
{
	...
	/**
	 * Find last item flow by file item_01. When method parametre is null we must ensure that the returned result is null
	 */
	@Test
	...
	/**
	 * Find last item flow by file item_02. When method parametre is not null we must ensure that the returned result is
	 * not null as well
	 */
	@Test
	...
	/**
	 * Find last sent item flow by file item_01. When method parameter is null we must ensure that the returned result is
	 * null
	 */
	@Test
	...
	/**
	 * Find last sent item flow by file item_02. When method parameter is not null we must ensure that the returned
	 * result is not null as well
	 */
	@Test
