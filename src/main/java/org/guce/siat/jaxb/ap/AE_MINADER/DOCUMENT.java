...
package org.guce.siat.jaxb.ap.AE_MINADER;
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="NUMERO_AE_MINADER" minOccurs="0">
 *                     &lt;simpleType>
 *                       &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *                         &lt;maxLength value="50"/>
 *                       &lt;/restriction>
...
public class DOCUMENT implements Serializable
{
	...
	{ "decisionorganisme", "codebureau", "client", "promoteur", "formulateur", "fabricantmatiereactive", "representantcameroun",
			"informationsgenerales", "signataire", "marchandises", "paiement", "decision", "causes", "numeroaeminader",
	...
	public static class CONTENT implements Serializable
	{
		...
		@XmlElement(name = "NUMERO_AE_MINADER")
		protected String numeroaeminader;
		...
		/**
		 * Obtient la valeur de la propriété numeroaeminader.
		 *
		 * @return possible object is {@link String }
		 *
		 */
		public String getNUMEROAEMINADER()
		{
			return numeroaeminader;
		}

		/**
		 * Définit la valeur de la propriété numeroaeminader.
		 *
		 * @param value
		 *           allowed object is {@link String }
		 *
		 */
		public void setNUMEROAEMINADER(final String value)
		{
			this.numeroaeminader = value;
		}
