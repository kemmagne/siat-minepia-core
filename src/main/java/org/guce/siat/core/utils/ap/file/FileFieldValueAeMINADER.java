...
/**
 * The Class FileFieldValueAeMINADER.
 */
public class FileFieldValueAeMINADER
{
	/**
	 * Generate file field value_ ae_ minader.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueAeMINADER(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.AE_MINADER.DOCUMENT document,
