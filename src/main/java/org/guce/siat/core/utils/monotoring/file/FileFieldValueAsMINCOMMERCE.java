...
/**
 * The Class FileFieldValueAsMINCOMMERCE.
 */
public class FileFieldValueAsMINCOMMERCE
{
	/**
	 * Generate file field value as mincommerce.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueAsMINCOMMERCE(final File file, final FileField fileField,
			final org.guce.siat.jaxb.monitoring.AS_MINCOMMERCE.DOCUMENT document,
			final ApplicationPropretiesService applicationPropretiesService)
	{
		...
		switch (fileField.getCode())
		{
			...
			case "INFORMATIONS_GENERALES_INSCRIPTION_FICHIER_NUMERO":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getINFORMATIONSGENERALES() != null
						&& document.getCONTENT().getINFORMATIONSGENERALES().getINSCRIPTIONFICHIER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getINFORMATIONSGENERALES().getINSCRIPTIONFICHIER().getNUMERO());
				}
				break;
			}
			case "INFORMATIONS_GENERALES_INSCRIPTION_FICHIER_DATE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getINFORMATIONSGENERALES() != null
						&& document.getCONTENT().getINFORMATIONSGENERALES().getINSCRIPTIONFICHIER() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getINFORMATIONSGENERALES().getINSCRIPTIONFICHIER()
							.getDATE()));
				}
				break;
			}
			case "INFORMATIONS_GENERALES_INSCRIPTION_FICHIER_VALIDITE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getINFORMATIONSGENERALES() != null
						&& document.getCONTENT().getINFORMATIONSGENERALES().getINSCRIPTIONFICHIER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getINFORMATIONSGENERALES().getINSCRIPTIONFICHIER().getVALIDITE());
				}
				break;
			}
