 ...
 */
public class FileItemFieldValueIDE
{
	/**
	 * Generate file item field value ide.
	 *
	 * @param fileItem
	 *           the file item
	 * @param fileItemField
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueIde(final FileItem fileItem, final FileItemField fileItemField,
			final org.guce.siat.jaxb.monitoring.IDE.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
