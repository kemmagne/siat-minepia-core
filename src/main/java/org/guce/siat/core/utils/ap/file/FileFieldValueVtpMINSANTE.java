...
/**
 * The Class FileFieldValueVtpMINSANTE.
 */
public class FileFieldValueVtpMINSANTE {

    /**
     * Generate file field value_ vt p_ minsante.
     *
     * @param file the file
     ...
     */
    public static FileFieldValue generateFileFieldValueVtpMINSANTE(final File file, final FileField fileField,
            final org.guce.siat.jaxb.ap.VTP_MINSANTE.DOCUMENT document,
