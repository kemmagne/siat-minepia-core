...
/**
 * The Class FileItemFieldValueAtMINSANTE.
 */
public class FileItemFieldValueAtMINSANTE
{
	/**
	 * Generate file item field value_ a t_ minsante.
	 *
	 * @param fileItem
	 *           the file item
	 * @param fileItemField
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueAtMINSANTE(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.ap.AT_MINSANTE.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
