...
/**
 * The Class FileFieldValueAsMINADER.
 */
public class FileFieldValueAsMINADER
{
	/**
	 * Generate file field value_ a s_ minader.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueAsMINADER(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.AS_MINADER.DOCUMENT document,
