 ...
 */
public class FileItemFieldValueAeMINMIDT
{
	/**
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueAeMINMIDT(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.ap.AE_MINMIDT.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
