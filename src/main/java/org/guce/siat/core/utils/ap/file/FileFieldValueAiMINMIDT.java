...
/**
 * The Class FileFieldValueAiMINMIDT.
 */
public class FileFieldValueAiMINMIDT
{
	/**
	 * Generate file field value_ a i_ minmidt.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueAiMINMIDT(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.AI_MINMIDT.DOCUMENT document,
