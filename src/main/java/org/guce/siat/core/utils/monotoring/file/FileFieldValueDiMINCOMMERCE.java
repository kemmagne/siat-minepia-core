...
/**
 * The Class FileFieldValueDiMINCOMMERCE.
 */
public class FileFieldValueDiMINCOMMERCE
{
	/**
	 * Generate file field value die mincommerce.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueDiMINCOMMERCE(final File file, final FileField fileField,
			final org.guce.siat.jaxb.monitoring.DI_MINCOMMERCE.DOCUMENT document,
