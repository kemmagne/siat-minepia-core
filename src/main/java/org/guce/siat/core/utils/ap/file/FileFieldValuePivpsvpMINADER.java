...
/**
 * The Class FileFieldValuePivpsvpMINADER.
 */
public class FileFieldValuePivpsvpMINADER
{
	/**
	 * Generate file field value_ pivpsr p_ minader.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValuePivpsrpMINADER(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.PIVPSRP_MINADER.DOCUMENT document,
			final ApplicationPropretiesService applicationPropretiesService)
	{
		...
		switch (fileField.getCode())
		{
			...
			case "NUMERO_IMPORTATION":
			{
				if (document.getCONTENT() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getNUMEROIMPORTATION());
				}
				break;
			}
			case "DATE_IMPORTATION":
			{
				if (document.getCONTENT() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getDATEIMPORTATION()));
				}
				break;
			}
			case "DATE_VALIDITE":
			{
				if (document.getCONTENT() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getDATEVALIDITE()));
				}
				break;
			}
			case "PORT_DESTINATION_CODE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getPORTDESTINATION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getPORTDESTINATION().getCODE());
				}
				break;
			}
			case "PORT_DESTINATION_NOM":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getPORTDESTINATION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getPORTDESTINATION().getNOM());
				}
				break;
			}
			case "PORT_DESTINATION_MODETRANSPORT_CODE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getPORTDESTINATION() != null
						&& document.getCONTENT().getPORTDESTINATION().getMODETRANSPORT() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getPORTDESTINATION().getMODETRANSPORT().getCODE());
				}
				break;
			}
			case "PORT_DESTINATION_MODETRANSPORT_LIBELLE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getPORTDESTINATION() != null
						&& document.getCONTENT().getPORTDESTINATION().getMODETRANSPORT() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getPORTDESTINATION().getMODETRANSPORT().getLIBELLE());
				}
				break;
			}
