...
/**
 * The Class FileFieldValueCeaMINMIDT.
 */
public class FileFieldValueCeaMINMIDT
{
	/**
	 * Generate file field value_ ce a_ minmidt.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueCeaMINMIDT(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.CEA_MINMIDT.DOCUMENT document,
