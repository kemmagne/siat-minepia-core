...
/**
 * The Class FileItemFieldValueDiMINCOMMERCE.
 */
public class FileItemFieldValueDiMINCOMMERCE
{
	/**
	 * Generate file item field value die mincommerce.
	 *
	 * @param fileItem
	 *           the file item
	 * @param fileItemField
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueDiMINCOMMERCE(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.monitoring.DI_MINCOMMERCE.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
