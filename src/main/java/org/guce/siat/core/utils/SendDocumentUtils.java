...
public final class SendDocumentUtils
{
	 ...
	 */
	public static File prepareApDocument(final Serializable documentSerializable, final String ebxmlFolder, String service,
			String documentType) throws JAXBException, SAXException, IOException
	{
	 ...
	 *            Signals that an I/O exception has occurred.
	 */
	public static File prepareCctDocument(final Serializable documentSerializable, final String ebxmlFolder, String service,
			String documentType) throws JAXBException, SAXException, IOException
	{
		JAXBContext jaxbContext = null;
		Marshaller jaxbMarshallerz = null;
		...
		if (documentSerializable instanceof org.guce.siat.jaxb.cct.CCT_CT_E.DOCUMENT)
		{
