...
/**
 * The Class FileItemFieldValueVtpMINSANTE.
 */
public class FileItemFieldValueVtpMINSANTE
{
	/**
	 * Generate file item field value_ vt p_ minsante.
	 *
	 * @param fileItem
	 *           the file item
	 * @param fileItemField
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueVtpMINSANTE(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.ap.VTP_MINSANTE.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
