...
/**
 * The Class FileItemFieldValueAiMINMIDT.
 */
public class FileItemFieldValueAiMINMIDT
{
	/**
	 * Generate file item field value_ a i_ minmidt.
	 *
	 * @param fileItem
	 *           the file item
	 * @param fileItemField
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueAiMINMIDT(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.ap.AI_MINMIDT.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
