...
/**
 * The Class FileItemFieldValueAieMINADER.
 */
public class FileItemFieldValueAieMINADER
{
	/**
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueAieMINADER(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.ap.AIE_MINADER.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
