...
/**
 * The Class FileFieldValueAtMINSANTE.
 */
public class FileFieldValueAtMINSANTE
{
	/**
	 * Generate file field value_ a t_ minsante.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueAtMINSANTE(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.AT_MINSANTE.DOCUMENT document,
