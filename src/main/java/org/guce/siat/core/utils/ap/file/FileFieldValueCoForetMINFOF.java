 ...
 */
public class FileFieldValueCoForetMINFOF
{
	/**
	 ...
	 */
	public static FileFieldValue generateFileFieldValueCoForetMINFOF(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.CO_MINFOF_FORET.DOCUMENT document,
