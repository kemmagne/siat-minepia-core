...
/**
 * The Class FileFieldValueDeMINCOMMERCE.
 */
public class FileFieldValueDeMINCOMMERCE
{

	/**
	 * Generate file field value de mincommerce.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueDeMINCOMMERCE(final File file, final FileField fileField,
			final org.guce.siat.jaxb.monitoring.DE_MINCOMMERCE.DOCUMENT document,
		...
		switch (fileField.getCode())
		{
			...
			case "INFORMATIONS_GENERALES_SIGNATAIRE_DATE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getINFORMATIONSGENERALES() != null
						&& document.getCONTENT().getINFORMATIONSGENERALES().getSIGNATAIRE() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDateSignatairePattern(document.getCONTENT().getINFORMATIONSGENERALES().getSIGNATAIRE()
							.getDATE()));
				}
				break;
			}
			...
			case "INFORMATIONS_GENERALES_BANQUE_DOMICILIATION_CODE_BANQUE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getINFORMATIONSGENERALES() != null
						&& document.getCONTENT().getINFORMATIONSGENERALES().getBANQUEDOMICILIATRICE() != null)
				{
					fileFieldValue
							.setValue(document.getCONTENT().getINFORMATIONSGENERALES().getBANQUEDOMICILIATRICE().getCODEBANQUE());
				}
				break;
			}
			case "INFORMATIONS_GENERALES_BANQUE_DOMICILIATION_LIBELLE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getINFORMATIONSGENERALES() != null
						&& document.getCONTENT().getINFORMATIONSGENERALES().getBANQUEDOMICILIATRICE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getINFORMATIONSGENERALES().getBANQUEDOMICILIATRICE().getLIBELLE());
				}
				break;
			}
			case "INFORMATIONS_GENERALES_MONTANT_FRET_MONTANT":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getINFORMATIONSGENERALES() != null
						&& document.getCONTENT().getINFORMATIONSGENERALES().getMONTANTFRET() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getINFORMATIONSGENERALES().getMONTANTFRET().getMONTANT());
				}
				break;
			}
			case "DOMICILIATION_CODE_BANQUE_DOMICILIATRICE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getDOMICILIATION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getDOMICILIATION().getCODEBANQUEDOMICILIATRICE());
				}
				break;
			}
			case "DOMICILIATION_NUMERO_DOMICILIATION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getDOMICILIATION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getDOMICILIATION().getNUMERODOMICILIATION());
				}
				break;
			}
			case "DOMICILIATION_DATE_VALIDITE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getDOMICILIATION() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getDOMICILIATION().getDATEVALIDITE()));
				}
				break;
			}
			case "DOMICILIATION_LIBELLE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getDOMICILIATION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getDOMICILIATION().getLIBELLE());
				}
				break;
			}
			case "DOMICILIATION_DATE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getDOMICILIATION() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getDOMICILIATION().getDATE()));
				}
				break;
			}
			case "VISA_EXPORT_DATE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getVISAEXPORT() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getVISAEXPORT().getDATE()));
				}
				break;
			}
			case "VISA_EXPORT_DATE_VALIDITE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getVISAEXPORT() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getVISAEXPORT().getDATEVALIDITE()));
				}
				break;
			}
			case "VISA_EXPORT_SERVICE_CHANGES":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getVISAEXPORT() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getVISAEXPORT().getSERVICECHANGES());
				}
				break;
			}
			case "VISA_EXPORT_NUMERO_DOMICILIATION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getVISAEXPORT() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getVISAEXPORT().getNUMERODOMICILIATION());
				}
				break;
			}
			case "SIGNATAIRE_NOM":
