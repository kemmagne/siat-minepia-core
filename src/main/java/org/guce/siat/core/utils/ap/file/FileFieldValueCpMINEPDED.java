...
/**
 * The Class FileFieldValueCpMINEPDED.
 */
public class FileFieldValueCpMINEPDED
{
	/**
	 * Generate file field value_ c p_ minepded.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueCpMINEPDED(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.CP_MINEPDED.DOCUMENT document,
			final ApplicationPropretiesService applicationPropretiesService)
	{
		...
		switch (fileField.getCode())
		{
			...
			case "EXPORTATION_PREPARATION_A_EXPORTER_A_APPELATION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getPREPARATIONAEXPORTER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getPREPARATIONAEXPORTER().getAAPPELATION());
				}
				break;
			}
			case "EXPORTATION_PREPARATION_A_EXPORTER_B_NOTIFICATIONEXPORTATION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getPREPARATIONAEXPORTER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getPREPARATIONAEXPORTER()
							.getBNOTIFICATIONEXPORTATION());
				}
				break;
			}
			case "EXPORTATION_INFORMATION_EXPORTATION_DATE_ESTIMEE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONEXPORTATION() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getEXPORTATION().getINFORMATIONEXPORTATION()
							.getDATEESTIMEE()));
				}
				break;
			}
			case "EXPORTATION_INFORMATION_EXPORTATION_CATEGORIE_PREVUE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONEXPORTATION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getINFORMATIONEXPORTATION().getCATEGORIEPREVUE());
				}
				break;
			}
			case "EXPORTATION_INFORMATION_DANGER_CLASSIFICATION_DANGER":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER().getCLASSIFICATIONDANGER());
				}
				break;
			}
			case "EXPORTATION_INFORMATION_DANGER_INFORMATIONS_DANGER":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER().getINFORMATIONSDANGER());
				}
				break;
			}
			case "EXPORTATION_INFORMATION_DANGER_INFORMATIONS_MESURE_PRECAUTION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER()
							.getINFORMATIONSMESUREPRECAUTION());
				}
				break;
			}
			case "EXPORTATION_INFORMATION_DANGER_REFERENCES":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getINFORMATIONDANGER().getREFERENCES());
				}
				break;
			}
			case "EXPORTATION_INFORMATION_PROPRIETES_RESUME_INFORMATIONS":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONPROPRIETES() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getINFORMATIONPROPRIETES().getRESUMEINFORMATIONS());
				}
				break;
			}
			case "EXPORTATION_INFORMATION_PROPRIETES_REFERENCES":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getINFORMATIONPROPRIETES() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getINFORMATIONPROPRIETES().getREFERENCES());
				}
				break;
			}
			case "EXPORTATION_RESUMES_INFORMATIONS_MESURE_RESUME_MESURE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE().getRESUMEMESURE());
				}
				break;
			}
			case "EXPORTATION_RESUMES_INFORMATIONS_MESURE_CATEGORIES":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE().getCATEGORIES());
				}
				break;
			}
			case "EXPORTATION_RESUMES_INFORMATIONS_MESURES_ETAT":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE().getETAT());
				}
				break;
			}
			case "EXPORTATION_RESUMES_INFORMATIONS_MESURES_REFERENCES":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getRESUMESINFORMATIONSMESURE()
							.getREFERENCEDOCUMENTREGLEMENTATION());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_RAISONSOCIALE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESEXPORTATEUR() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getRAISONSOCIALE());
				}
				break;
			}
			...
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESEXPORTATEUR() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESEXPORTATEUR()
								.getADRESSE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getADRESSE1());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_ADRESSE_ADRESSE2":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getADRESSE2());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_ADRESSE_BP":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getBP());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_ADRESSE_PAYSADDRESS_CODEPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
						...
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESEXPORTATEUR()
								.getADRESSE() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESEXPORTATEUR()
								.getADRESSE().getPAYSADRESSE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getPAYSADRESSE().getCODEPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_ADRESSE_PAYSADDRESS_NOMPAYS":
			{
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getPAYSADRESSE().getNOMPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_ADRESSE_VILLE":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getVILLE());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_ADRESSE_ADRESSEELECTRONIQUE":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getEMAIL());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEURADRESSE_SITEWEB":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getADRESSE().getSITEWEB());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_TELEPHONE_FIXE_INDICATIFPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getTELEPHONEFIXE().getINDICATIFPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_TELEPHONE_FIXE_NUMERO":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getTELEPHONEFIXE().getNUMERO());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_TELEPHONE_MOBILE_INDICATIFPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getTELEPHONEMOBILE().getINDICATIFPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_TELEPHONE_MOBILE_NUMERO":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getTELEPHONEMOBILE().getNUMERO());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_FAX_INDICATIFPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESEXPORTATEUR() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESEXPORTATEUR().getFAX() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getFAX().getINDICATIFPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_EXPORTATEUR_FAX_NUMERO":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESEXPORTATEUR().getFAX().getNUMERO());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_RAISONSOCIALE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESIMPORTATEUR() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getRAISONSOCIALE());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_ADRESSE1":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESIMPORTATEUR() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESIMPORTATEUR()
								.getADRESSE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getADRESSE1());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_ADRESSE2":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getADRESSE2());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_BP":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getBP());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_PAYSADDRESS_CODEPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getPAYSADRESSE().getCODEPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_PAYSADDRESS_NOMPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getPAYSADRESSE().getNOMPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_VILLE":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getVILLE());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_ADRESSEELECTRONIQUE":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getEMAIL());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_ADRESSE_SITEWEB":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getADRESSE().getSITEWEB());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_TELEPHONE_FIXE_INDICATIFPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getTELEPHONEFIXE().getINDICATIFPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_TELEPHONE_FIXE_NUMERO":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getTELEPHONEFIXE().getNUMERO());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_TELEPHONE_MOBILE_INDICATIFPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getTELEPHONEMOBILE().getINDICATIFPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_TELEPHONE_MOBILE_NUMERO":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getTELEPHONEMOBILE().getNUMERO());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_FAX_INDICATIFPAYS":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESIMPORTATEUR() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES().getAUTORITESIMPORTATEUR().getFAX() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getFAX().getINDICATIFPAYS());
				}
				break;
			}
			case "EXPORTATION_AUTORITES_NATIONALES_DESIGNEES_AUTORITES_IMPORTATEUR_FAX_NUMERO":
			{
				if (document.getCONTENT() != null
						&& document.getCONTENT().getEXPORTATION() != null
						&& document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES() != null
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getEXPORTATION().getAUTORITESNATIONALESDESIGNEES()
							.getAUTORITESIMPORTATEUR().getFAX().getNUMERO());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_PAYS_IMPORTATEUR_CODEPAYS":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getPAYSIMPORTATEUR() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getPAYSIMPORTATEUR().getCODEPAYS());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_PAYS_IMPORTATEUR_NOMPAYS":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getPAYSIMPORTATEUR() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getPAYSIMPORTATEUR().getNOMPAYS());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_TYPE_DECISION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getTYPEDECISION());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_DECISION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getDECISION());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_DATE_DECISION":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null)
				{
					fileFieldValue.setValue(FileFieldValueUtils.formatDatePattern(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION()
							.getDATEDECISION()));
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_SIGNATAIRE_NOM":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getSIGNATAIRE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getSIGNATAIRE().getNOM());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_SIGNATAIRE_QUALITE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getSIGNATAIRE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getSIGNATAIRE()
							.getQUALITE());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_SIGNATAIRE_LIEU":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getSIGNATAIRE() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getSIGNATAIRE().getLIEU());
				}
				break;
			}
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_SIGNATAIRE_DATE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getSIGNATAIRE() != null)
			...
			case "REPONSE_PAYS_IMPORTATEUR_DECISION_QUALITE":
			{
				if (document.getCONTENT() != null && document.getCONTENT().getREPONSEPAYSIMPORTATEUR() != null
						&& document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getREPONSEPAYSIMPORTATEUR().getDECISION().getQUALITE());
				}
				break;
			}
			default:
