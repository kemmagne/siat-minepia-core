...
/**
 * The Class FileFieldValueIDI.
 */
public class FileFieldValueIDI
{
	/**
	 * Generate file field value idi.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueIdi(final File file, final FileField fileField,
			final org.guce.siat.jaxb.monitoring.IDI.DOCUMENT document,
			final ApplicationPropretiesService applicationPropretiesService)
	{
		...
		switch (fileField.getCode())
		{
			...
			case "DATE_DI":
			{
				if (document.getCONTENT() != null)
				{
					fileFieldValue.setValue(document.getCONTENT().getDATEDI());
				}
				break;
			}
			case "NUMERO_DI":
