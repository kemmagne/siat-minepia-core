...
import org.guce.siat.jaxb.monitoring.IRPM_MINCOMMERCE.DOCUMENT;
 ...
 * @author yenke
 */
public class FileFieldValueIrmpMINCOMMERCE {

    public static FileFieldValue generateFileFieldValueIrmpMINCOMMERCE(final File file, final FileField fileField,
        ...
        switch (fileField.getCode()) {
            ...
            case "NUMERO_ARRETE_APPROBATION" : {
                if (document.getCONTENT() != null) {
                    fileFieldValue.setValue(document.getCONTENT().getNUMEROARRETEAPPROBATION());
                }
                break;
            }
