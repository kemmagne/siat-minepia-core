 ...
 */
public class FileItemFieldValueCoFauneMINFOF
{
	/**
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueCoFauneMINFOF(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.ap.CO_MINFOF_FAUNE.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
