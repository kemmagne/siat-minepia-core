...
/**
 * The Class FileItemFieldValueAsMINADER.
 */
public class FileItemFieldValueAsMINADER
{
	/**
	 * Generate file item field value_ a s_ minader.
	 *
	 * @param fileItem
	 *           the file item
	 * @param fileItemField
	 ...
	 */
	public static FileItemFieldValue generateFileItemFieldValueAsMINADER(final FileItem fileItem,
			final FileItemField fileItemField,
			final org.guce.siat.jaxb.ap.AS_MINADER.DOCUMENT.CONTENT.MARCHANDISES.MARCHANDISE marchandise)
	{
