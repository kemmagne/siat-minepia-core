...
/**
 * The Class FileFieldValueAsMINFOF.
 */
public class FileFieldValueAsMINFOF
{
	/**
	 * Generate file field value_ a s_ minfof.
	 *
	 * @param file
	 *           the file
	 * @param fileField
	 ...
	 */
	public static FileFieldValue generateFileFieldValueAsMINFOF(final File file, final FileField fileField,
			final org.guce.siat.jaxb.ap.AS_MINFOF.DOCUMENT document, final ApplicationPropretiesService applicationPropretiesService)
	{
		...
		switch (fileField.getCode())
		{
			case "TYPE_AUTORISATION":
			{
				...
				{
					fileFieldValue.setValue(document.getCONTENT().getTYPEAUTORISATION());
				}
				break;
			}
			case "CODE_BUREAU":
