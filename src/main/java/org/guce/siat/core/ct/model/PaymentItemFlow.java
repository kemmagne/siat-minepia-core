...
public class PaymentItemFlow extends AbstractModel implements Serializable {
     ...
     * @param deleted
     * @param fileItemId
     * @param fileItemHsCode
     */
    public PaymentItemFlow(Boolean deleted, Long fileItemId, Item nsh) {
        this.deleted = deleted;
        this.fileItemId = fileItemId;
        this.nsh = nsh;
    }
     ...
     *
     * @param fileItemId the new file item id
     */
     ...
     *
     * @param natureFrais the new nature frais
     */
