...
public interface CtDocumentReciever
{
	 ...
	 */
	HashMap<String, Object> uploadEbxmlFile(final Map<String, Object> ebxmlBytes) throws ValidationException, ParseException,
	 ...
	 *            the exception
	 */
	HashMap<String, Object> generateAperakCFile(final Map<String, Object> ebxmlBytes, final String errorMessage) throws Exception;
