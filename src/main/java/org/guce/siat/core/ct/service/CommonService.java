...
public interface CommonService extends AbstractService<ItemFlow> {
     ...
     * @param itemFlowsToAdd the item flows to add
     */
    void takeDecisionAndSaveAnalyseRequest(List<AnalysePart> analysePartsList, AnalyseOrder analyseOrder, List<ItemFlow> itemFlowsToAdd);
     ...
     * @param itemFlowsToAdd the item flows to add
     */
    void takeDecisionAndSaveTreatmentRequest(List<TreatmentPart> treatmentPartsList, TreatmentOrder treatmentOrder, List<ItemFlow> itemFlowsToAdd);
     ...
     * @return the list
     */
    List<FileItem> fileItemByDesicionByFilter(final Filter filter, final User loggedUser, List<String> flowList, List<String> restrectionFlowCode, final Administration administration);
     ...
     * @return the list
     */
    List<Object[]> serviceItemProductsQuantitiesByDrdByFilter(Filter filter, List<String> flowCodeList, User loggedUser, Administration currentAdministration);
