...
INSERT INTO SIAT_CT.POSITION_AUTHORITY (POSITION_TYPE,AUTHORITY_ID) VALUES ('CHEF_SECTEUR',(SELECT ID FROM SIAT_CT.AUTHORITY WHERE ROLE = 'SIGN'));
...
INSERT INTO SIAT_CT.PARAMS (ID,NAME,VALUE,CATEGORY) VALUES (SIAT_CT.PARAMS_SEQ.NEXTVAL,'system.automatic.decison.PPPKP.CCT_CT_E.ST_CT_65','FL_CT_153','GN');
