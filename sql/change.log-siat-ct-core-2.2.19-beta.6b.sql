...
INSERT INTO SIAT_CT.STEP_AUTHORITY (STEP_ID, AUTHORITY_ID) VALUES ((SELECT ID FROM SIAT_CT.STEP WHERE CODE = 'ST_CT_64'), (SELECT ID FROM SIAT_CT.AUTHORITY WHERE ROLE = 'SIGN'));
...
INSERT INTO SIAT_CT.FLOW (ID,CODE,DURATION,IS_COTA,LABELEN,LABELFR,OUTGOING,FROM_STEP,TO_STEP) VALUES (SIAT_CT.FLOW_SEQ.NEXTVAL,'FL_CT_142',24,0,'Notification after potting report signature','Notification suite signature rapport empotage',0,NULL,(SELECT ID FROM SIAT_CT.STEP WHERE CODE = 'ST_CT_63'));

--
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_130'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_130'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_130'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_131'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_131'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_131'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_132'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_132'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_132'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_133'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_133'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_133'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_134'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_134'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_134'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_135'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_135'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_135'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_136'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_136'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_136'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_137'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_137'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_137'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_138'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_138'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_138'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_139'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_139'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_139'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_140'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_140'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_140'));
INSERT INTO SIAT_CT.FILE_TYPE_FLOW (LABEL_EN,LABEL_FR,FILE_TYPE_ID,FLOW_ID) VALUES ((SELECT LABELEN FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_141'),(SELECT LABELFR FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_141'),(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'),(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_141'));

--
UPDATE SIAT_CT.DATA_TYPE SET PROPS = 'fileTypes=CCT_CT_E,CCT_CT_E_ATP,CCT_CT_E_FSTP,CCT_CT_E_PVI' WHERE FLOW_ID = (SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_07') AND CODE IS NULL;
INSERT INTO SIAT_CT.DATA_TYPE (ID,FLOW_ID,LABEL,LABEL_EN,REQUIRED,TYPE) VALUES (SIAT_CT.DATA_TYPE_SEQ.NEXTVAL,(SELECT ID FROM SIAT_CT.FLOW WHERE CODE = 'FL_CT_131'),'Observations','Observations',0,'inputTextarea');
...
--
--UPDATE SIAT_CT.FLOW_GUCE_SIAT SET FLOW_GUCE = 'E013' WHERE FLOW_SIAT = 'FL_CT_118' AND FILE_TYPE_ID = (SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'); -- il doit y avoir une seule ligne mise à jour
...
INSERT INTO SIAT_CT.FLOW_GUCE_SIAT (ID,FLOW_GUCE,FLOW_SIAT,FILE_TYPE_ID) VALUES (SIAT_CT.FLOW_GUCE_SIAT_SEQ.NEXTVAL,'E025','FL_CT_142',(SELECT ID FROM SIAT_CT.FILE_TYPE WHERE CODE = 'CCT_CT_E_PVE'));
